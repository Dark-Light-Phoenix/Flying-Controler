...
#define R_ACCEL 0.01
#define R_GYRO 0.01
#define BMP280_ADDRESS 0x76 // Define address of BMP280
#define SEA_LEVEL_PRESSURE 1013.25 // Average atmosphere pressure on sea level
#define PRESSURE_CONST 44330.0 // Constant for convert pressure in height
